...
export class PieChartSentiment extends React.Component {
  ...
  computeDatasets() {
    return [
      {
        label:
          "Percentage of negative and positive tweets in the last seven days",
        data: [this.props.positiveCount, this.props.negativeCount],
        backgroundColor: ["rgb(137,234,102)", "rgb(189,73,73)"],
        borderColor: ["rgb(94,211,52)", "rgb(199,48,48)"],
        hoverBorderColor: ["rgb(77,222,25)", "rgb(227,20,20)"],
        hoverOffset: 4,
      },
    ];
  }
